<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Q-I3.aspx.cs" Inherits="project.Q_I3" %>
    ...
    <table align="center" class="auto-style28">
        <tr>
            <td class="auto-style27"><strong>
                <asp:Label ID="Label1" runat="server" Font-Italic="False" Font-Names="Microsoft YaHei Light" Font-Size="22px" ForeColor="#000066" Text="Within the past 6 months, do you often forget where you placed important items– like your keys, glasses or wallet–  and end up spending time hunting it down?" CssClass="auto-style29"></asp:Label>
                </strong></td>
        </tr>
        <tr>
