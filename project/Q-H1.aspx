<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Q-H1.aspx.cs" Inherits="project.Q_H1" %>
    ...
    <table align="center" class="auto-style28">
        <tr>
            <td class="auto-style27"><strong>
                <asp:Label ID="Label1" runat="server" Font-Italic="False" Font-Names="Microsoft YaHei Light" Font-Size=22px ForeColor="#000066" Text="Within the past 6 months, have you often felt as if you need to get up and move around, or change your position frequently, when you're sitting for extended periods of time, such as during meetings or in class?" CssClass="auto-style29"></asp:Label>
                </strong></td>
        </tr>
        <tr>
