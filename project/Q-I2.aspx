<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Q-I2.aspx.cs" Inherits="project.QI2" %>
    ...
    <table align="center" class="auto-style28">
        <tr>
            <td class="auto-style27"><strong>
                <asp:Label ID="Label1" runat="server" Font-Italic="False" Font-Names="Microsoft YaHei Light" Font-Size="22px" ForeColor="#000066" Text="Within the past 6 months, do you often find routine tasks boring and often have to force yourself to complete these tasks at work and/or school?" CssClass="auto-style29"></asp:Label>
                </strong></td>
        </tr>
        <tr>
