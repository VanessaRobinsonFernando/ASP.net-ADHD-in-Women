<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Q2e.aspx.cs" Inherits="project.Q2e" %>
    ...
    <table align="center" class="auto-style28">
        <tr>
            <td class="auto-style27"><strong>
                <asp:Label ID="Label1" runat="server" Font-Italic="False" Font-Names="Microsoft YaHei Light" Font-Size="22px" ForeColor="#000066" Text="Do you make big issues out of minor problems?" CssClass="auto-style29"></asp:Label>
                </strong></td>
        </tr>
        <tr>
