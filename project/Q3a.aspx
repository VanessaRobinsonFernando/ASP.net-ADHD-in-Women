<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Q3a.aspx.cs" Inherits="project.Q3a" %>
    ...
    <table align="center" class="auto-style28">
        <tr>
            <td class="auto-style27"><strong>
                <asp:Label ID="Label1" runat="server" Font-Italic="False" Font-Names="Microsoft YaHei Light" Font-Size="22px" ForeColor="#000066" Text="Do you often fidget with your hands or legs and cannot sit idle?" CssClass="auto-style29"></asp:Label>
                </strong></td>
        </tr>
        <tr>
