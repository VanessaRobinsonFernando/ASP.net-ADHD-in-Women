<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Q4d.aspx.cs" Inherits="project.Q4d" %>
    ...
    <table align="center" class="auto-style28">
        <tr>
            <td class="auto-style27"><strong>
                <asp:Label ID="Label1" runat="server" Font-Italic="False" Font-Names="Microsoft YaHei Light" Font-Size="22px" ForeColor="#000066" Text="Are you unable to follow instructions and fail to finish college work or duties in the workplace?" CssClass="auto-style29"></asp:Label>
                </strong></td>
        </tr>
        <tr>
