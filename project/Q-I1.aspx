<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Q-I1.aspx.cs" Inherits="project.QI1" %>
    ...
    <table align="center" class="auto-style28">
        <tr>
            <td class="auto-style27"><strong>
                <asp:Label ID="Label1" runat="server" Font-Italic="False" Font-Names="Microsoft YaHei Light" Font-Size="22px" ForeColor="#000066" Text="Within the past 6 months, have you often found yourself at the end of a conversation and you realize that you do not know what the conversation was about?" CssClass="auto-style29"></asp:Label>
                </strong></td>
        </tr>
        <tr>
