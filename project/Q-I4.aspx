<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Q-I4.aspx.cs" Inherits="project.Q_I4" %>
    ...
    <table align="center" class="auto-style28">
        <tr>
            <td class="auto-style27"><strong>
                <asp:Label ID="Label1" runat="server" Font-Italic="False" Font-Names="Microsoft YaHei Light" Font-Size="22px" ForeColor="#000066" Text="Within the past 6 months, have you often found yourself unable to remember instructions unless you write them down?" CssClass="auto-style29"></asp:Label>
                </strong></td>
        </tr>
        <tr>
