<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Q-I6.aspx.cs" Inherits="project.Q_I6" %>
    ...
    <table align="center" class="auto-style28">
        <tr>
            <td class="auto-style27"><strong>
                <asp:Label ID="Label1" runat="server" Font-Italic="False" Font-Names="Microsoft YaHei Light" Font-Size="22px" ForeColor="#000066" Text="Within the past 6 months, do you often need to write regular reminders to yourself to do most activities or tasks, otherwise you will forget?" CssClass="auto-style29"></asp:Label>
                </strong></td>
        </tr>
        <tr>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <tr>
            <td class="auto-style30">
                <asp:Label ID="labelYes" runat="server"></asp:Label>
