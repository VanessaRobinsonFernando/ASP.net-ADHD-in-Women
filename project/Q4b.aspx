<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Q4b.aspx.cs" Inherits="project.Q4b" %>
    ...
    <table align="center" class="auto-style28">
        <tr>
            <td class="auto-style27"><strong>
                <asp:Label ID="Label1" runat="server" Font-Italic="False" Font-Names="Microsoft YaHei Light" Font-Size="22px" ForeColor="#000066" Text="Do you face difficulties in staying alert?" CssClass="auto-style29"></asp:Label>
                </strong></td>
        </tr>
        <tr>
