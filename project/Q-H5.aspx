<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Q-H5.aspx.cs" Inherits="project.Q_H5" %>
    ...
    <table align="center" class="auto-style28">
        <tr>
            <td class="auto-style27"><strong>
                <asp:Label ID="Label1" runat="server" Font-Italic="False" Font-Names="Microsoft YaHei Light" Font-Size="22px" ForeColor="#000066" Text="Within the past 6 months, do you often make decisions without fully thinking them through or  considering the potential consequences of your actions?" CssClass="auto-style29"></asp:Label>
                </strong></td>
        </tr>
        <tr>
